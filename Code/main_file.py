...
os.chdir("C:/Users/91990/Desktop/Final year project/Hand-Gesture-Recognition-for-Presentation-Process-in-Python-master")
...
while(1):    
        ...
        fist=fist_cascade.detectMultiScale(gray,1.6, 5)
